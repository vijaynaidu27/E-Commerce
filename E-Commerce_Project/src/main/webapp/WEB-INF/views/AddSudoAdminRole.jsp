...
<header>
    <div class="container">
        ...
        <h1 class="multicolor"><b>Add New Role</b></h1>
    </div>
</header>
            ...
            <div class="card-body">
                <form action="/addrole" method="post" >
                    ...
                    <fieldset class="form-group">
                        <label>Role Name</label> <input type="text" class="form-control" name="rolename" required="required">
                    </fieldset>
                    <button type="submit" class="btn btn-success">Save</button>
                      <a href="<%=request.getContextPath()%>/roleAdmin" class="btn btn-danger">Back</a>
                </form>
            </div>
        </div>
    </div>
