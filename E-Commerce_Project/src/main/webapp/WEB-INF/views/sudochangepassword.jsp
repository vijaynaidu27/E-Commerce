  ...
  <div class="wrapper">
    <form action="/newpassword" method="post">
      ...
      <div class="input-box">
        ...
        <input type="userLoginId"  id="id" placeholder="EntrerNew sudo adminid" name="adminId"  required">
      ...
      <div class="input-box">
        ...
        <input type="password"  id="newPassword" placeholder="EntrerNew Password" name="newPassword"  required">
