            ...
            <div class="card-body">
                <form action="/additem" method="post" >
                    ...
                    <fieldset class="form-group">
                        <label>Item Category</label> <input type="text" class="form-control" name="itemc" required="required">
                    </fieldset>

                    <fieldset class="form-group">
                    <label>Item Category Short Code</label> <input type="text" class="form-control" name="itemcsc" required="required">
                </fieldset>
                ...
                <label> Description </label> <input type="text" class="form-control" name="desc" >
                    ...
                    <a href="<%=request.getContextPath()%>/itemc" class="btn btn-danger">Back</a>
                </form>
            </div>
        </div>
    </div>
