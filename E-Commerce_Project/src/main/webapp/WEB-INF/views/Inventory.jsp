...
<div class="header-nav">
  ...
  <a href="<%=request.getContextPath()%>/itemc">ItemCategory</a>
  <a href="<%=request.getContextPath()%>/item">Item</a>
  <a href="<%=request.getContextPath()%>/stock">Stock</a>
<a href="<%=request.getContextPath()%>/DashboardLogin" class="button">LogOut</a>
