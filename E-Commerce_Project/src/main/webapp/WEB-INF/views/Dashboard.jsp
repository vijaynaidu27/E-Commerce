...
<head>
 ...
 .nav{
    ...
    border-radius: 0 50px 0 0;
     box-shadow: 2px 2px 20px 2px rgb(52, 32, 63);
        }
.nav ol{
    position: relative;
   width: 100%;
...
<body>
    <div class="header">
        ...
        <p id="b"> body Shoping Management</p>
   ...
   <div class="nav">
       <ol>
           ...
           <li><a href="#2"><i class="fa-brands fa-jedi-order"></i>Customer Order</a></li>
           <li><a href="#3"><i class="fa-solid fa-money-check-dollar"></i>Payments</a></li>
           <li><a href="#4"><i class="fa-solid fa-person"></i></i>Customers</a></li>
           <li><a href="#5"><i class="fa-solid fa-cart-shopping"></i>occasional Sale</a></li>
           <li><a href="#6"><i class="fa-solid fa-briefcase"></i>Item Catalog</a></li>
           <li><a href="#7"><i class="fa-solid fa-book"></i>Inventory</a></li>
           <li><a href="#8"><i class="fa-solid fa-clipboard"></i>Dash Board</a></li>
