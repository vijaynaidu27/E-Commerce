...
<body>
    ...
    <div class="container">
        ...
        <div class="container text-left">
            <a href="<%=request.getContextPath()%>/add" class="btn btn-success">Add New Item</a>
                ...
                <tbody>
                    <c:forEach var="inv" items="${Inventory}">
                        <tr>
                            ...
                            <td><c:out value="${inv.itemShortCode}" /></td>
                            ...
                            <td>
                                <a href="edit?itemId=<c:out value='${inv.itemId}' />">Edit</a> &nbsp;&nbsp;&nbsp;&nbsp;
                                <a href="deleteIt?itemId=<c:out value='${inv.itemId}' />">Delete</a> &nbsp;&nbsp;&nbsp;
                            </td>
                        </tr>
                    </c:forEach>
                </tbody>
