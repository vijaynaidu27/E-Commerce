...
<header>
    <div class="container">
        ...
        <h1 class="multicolor"><b>Add Item</b></h1>
    </div>
</header>
...
<div class="container">
            ...
            <div class="card-body">
                <form action="/add" method="post" >
                    ...
                    <fieldset class="form-group">
                        <label>Item Name</label> <input type="text" class="form-control" name="itemn" required="required">
                    </fieldset>

                    <fieldset class="form-group">
                    <label>Item Short Code</label> <input type="text" class="form-control" name="itemsc" required="required">
                </fieldset>
    ...
    <select id="itemCategory" name="itemCategory">
        ...
        <c:forEach var="itemc" items="${ItemCategory}">
        	
            <option value="${itemc.itemCategory}">${itemc.itemCategory}</option>
...
<fieldset class="form-group">
                <label> Item Old Price </label> <input type="text" class="form-control" name="itemop" >
            </fieldset>

 <fieldset class="form-group">
                <label> Item Price </label> <input type="text" class="form-control" name="itemp" >
            </fieldset>
      
       <fieldset class="form-group">
                <label> Item Status</label> <input type="text" class="form-control" name="items" >
            </fieldset>

                    <button type="submit" class="btn btn-success">Save</button>
                     <a href="<%=request.getContextPath()%>/item" class="btn btn-danger">Back</a>
                </form>
            </div>
        </div>
    </div>
