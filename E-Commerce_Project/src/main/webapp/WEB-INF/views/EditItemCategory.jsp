...
<header>
    <div class="container">
        ...
        <h1 class="multicolor"><b>Edit Item Category</b></h1>
    </div>
</header>
        ...
        <div class="custom-div">
            <div class="card-body">
                <form action="/edititem" method="post" >
                    ...
                    <fieldset class="form-group">
                    <label>Item Category Short Code</label> <input type="text" value="<c:out value='${item.itemCategoryShortCode}' />" class="form-control" name="itemcsc" required="required">
                </fieldset>

                <fieldset class="form-group">
                <label> Description </label> <input type="text" value="<c:out value='${item.itemCategoryDescription}' />" class="form-control" name="desc" >
            </fieldset>
