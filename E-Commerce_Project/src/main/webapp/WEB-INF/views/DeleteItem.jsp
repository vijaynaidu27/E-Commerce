...
<header>
    <div class="container">
        ...
        <h1 class="multicolor"><b>Delete Item</b></h1>
    </div>
</header>
...
<fieldset class="form-group">
                    ...
                    <fieldset class="form-group">
                        <label>Item Name</label> <input type="text" value="<c:out value='${item.itemName}' />" class="form-control" name="itemn" readonly>
                    </fieldset>

                    <fieldset class="form-group">
                    <label>Item Short Code</label> <input type="text" value="<c:out value='${item.itemShortCode}' />"class="form-control" name="itemsc" readonly>
                </fieldset>
    ...
    <select id="itemCategory" name="itemCategory" >
        ...
        <c:forEach var="item" items="${ItemCategory}">
          ...
          <fieldset class="form-group">
                <label> Description </label> <input type="text" value="<c:out value='${item.itemDescription}' />" class="form-control" name="desc" readonly>
            </fieldset>
...
<fieldset class="form-group">
 ...
 <fieldset class="form-group">
                <label> Item Price </label> <input type="text" value="<c:out value='${item.itemPrice}' />"class="form-control" name="itemp" readonly>
            </fieldset>
      
       <fieldset class="form-group">
                <label> Item Status</label> <input type="text" value="<c:out value='${item.itemStatus}' />"class="form-control" name="items" readonly>
            </fieldset>
